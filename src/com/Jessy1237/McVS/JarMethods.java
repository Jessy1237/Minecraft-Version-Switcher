...
public class JarMethods extends JFrame{
	...
	public static void read() throws IOException, ClassNotFoundException{
		...
		if(names.containsValue("1.7") == false) names.put("1.7", "1.7");
		if(names.containsValue("1.8") == false) names.put("1.8", "1.8");
		if(names.containsValue("1.0") == false) names.put("1.0", "1.0");
		if(names.containsValue("1.1") == false) names.put("1.1", "1.1");
		if(names.containsValue("1.2") == false) names.put("1.2", "1.2");
